...
class AddVerticesMedidasAndColindanciasToLotes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('lotes', function (Blueprint $table) {
            $table->string('vertices')->after('superficie')->nullable();
            $table->string('medidas')->after('vertices')->nullable();
            $table->string('colindancias')->after('medidas')->nullable();
        });
    }
